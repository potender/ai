...
def main():
    pygame.init()
    pygame.font.init()
    pygame.display.set_caption("Fireworks in 2024")  # 标题
    background = pygame.image.load("img_2.jpg")  # 背景
    myfont = pygame.font.Font("simkai.ttf", 50)
    myfont1 = pygame.font.Font("simkai.ttf", 30)

    testsurface = myfont.render("愿君旧事归于尽，来年依旧迎花开", False, (0, 0, 0))
    testsurface1 = myfont1.render("     ——系铃人", False, (0, 0, 0))
    ...
    while running:
        ...
        """x,y"""
        win.blit(testsurface, (150, 720))
        win.blit(testsurface1, (900, 750))
